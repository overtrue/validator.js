...
(function(data, validateRules, messages) {
  ...
  Validator.prototype = {
    ...
    passes: function() {
      ...
      for (var attribute in rulesArray) {
        ...
        for (var i in rules) {
          ...
          var validatable = is_function(this.resolvers[rule]);
          if (validatable && !this.resolvers[rule].call(this, attribute, value, parameters)) {
    ...
    _addFailure: function(attribute, rule, parameters) {
      this._addError(attribute, rule, parameters);
    ...
    _getMessage: function(attribute, rule) {
      ...
      if (is_object(message)) {
        var value = this._getValue(attribute);  
        if (is_array(value) && message['array']) {
          return message['array'];
        } else if (this.resolvers.numeric(value) && message['numeric']) {
    ...
    _allFailingRequired: function(attributes) {
      for (var i in attributes) {
        ...
        if (this.resolvers.validateRequired(key, this._getValue(key))) {
          return false;
        }
      }
    ...
    _anyFailingRequired: function(attributes) {
      for (var i in attributes) {
        ...
        if ( ! this.resolvers.validateRequired(key, this.date[key])) {
          return true;
        }
      }
    ...
    resolvers : {
      accepted: function(attribute, value) {
        ...
        return (this.resolvers.required(attribute, value) && in_array(value, acceptable, true));
      },
      ...
      confirmed: function(attribute, value, parameters) {
        return this.resolvers.same(attribute, value, [attribute + '_confirmation']);
      },
      ...
      different: function(attribute, value, parameters) {
        return ! this.resolvers.same(attribute, value, parameters);
      },
      ...
      required: function(attribute, value) {
        if (typeof value == undefined) {
          return false;
        } else if (value && (is_string(value) || is_array(value) || is_object(value)) && !value.length) {
          return false;
        } 
      ...
      required_if: function(attribute, value, parameters) {
        ...
        if (in_array(data, values)) {
          return this.resolvers.required(attribute, value);
        }
      ...
      required_without: function(attribute, value, parameters) {
        if (this._anyFailingRequired(parameters)) {
          return this.resolvers.required(attribute, value);
        }
  ...
  Validator.register = function(rule, fn, errMsg) {
    ...
    messages[rule] = (is_string(errMsg)) ? errMsg : messages['def'];
  };
